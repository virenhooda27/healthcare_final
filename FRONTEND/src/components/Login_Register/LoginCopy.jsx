            ...
            {!isLoginView && (
              <div className="grid grid-cols-3 gap-8">
                ...
                {selectedRole === 'staff' && (
                  <div>
                    <div>
                      <label htmlFor="staff-specific-field" className="block text-gray-700 font-bold mb-2">
                        Staff Specific Field
                      </label>
                      <input
                        id="staff-specific-field"
                        name="staff-specific-field"
                        type="text"
                        autoComplete="off"
                        required
                        className="appearance-none rounded relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm"
                        placeholder="Staff Specific Field"
                      />
                    </div>
...
export default LoginRegisterForm_Copy;
